...
ingredient1 = Ingredient.create(name: "bread", calories: 25, carbs: 37, fiber: 25, sugar: 62)
ingredient2 = Ingredient.create(name: "eggs", calories: 28, carbs: 37, fiber: 10, sugar: 25)
ingredient3 = Ingredient.create(name: "Chicken", calories: 56, carbs: 25, fiber: 62, sugar: 37)
ingredient4 = Ingredient.create(name: "broccoli", calories: 22, carbs: 62, fiber: 10, sugar: 37)
ingredient5 = Ingredient.create(name: "chicken stock", calories: 46, carbs: 62, fiber: 25, sugar: 62)
ingredient6 = Ingredient.create(name: "rice", calories: 55, carbs: 25, fiber: 37, sugar: 62)
